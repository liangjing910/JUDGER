...
sys2 = '''
Suppose you are a visual question answering (VQA) expert. You are presented with an image, a question about the image, a student's response (model answer), and the correct answer.

Your task is to first determine whether the student's response is correct by considering the visual context described in the image and the question.

If the student's response is correct, please directly output: ### The response is correct. ###

If the response is wrong, analyze why the answer is incorrect. Please mention which part of the image or what visual details might have been overlooked or misinterpreted. Provide a concise explanation focusing on the discrepancy between the model answer and the correct answer.
'''
